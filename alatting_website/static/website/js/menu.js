...
function ratingRate(rate){
    $.post(ratingURL, {"rate": rate}).done(function(object){
        ...
        menu.find('.rate-rating').html(object.poster_rating.ratings_average)
        menu.find('.rating-count').html(object.poster_rating.ratings_count)
        menu.find('.rating-average').rating('update', object.poster_rating.ratings_average)
        menu.find('.rate-five').css('width', object.poster_rating.five_percent + '%')
        .html(object.poster_rating.five_count)
        menu.find('.rate-four').css('width', object.poster_rating.four_percent + '%')
        .html(object.poster_rating.four_count)
        menu.find('.rate-three').css('width', object.poster_rating.three_percent + '%')
        .html(object.poster_rating.three_count)
        menu.find('.rate-two').css('width', object.poster_rating.two_percent + '%')
        .html(object.poster_rating.two_count)
        menu.find('.rate-one').css('width', object.poster_rating.one_percent + '%')
        .html(object.poster_rating.one_count)
