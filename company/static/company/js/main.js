!function($){      
  $(function(){
	 $('.slider ul').bxSlider({
	  ...
	  $('.navright li').mouseover(function(){
                $(this).find('.big-tu').show();
            });
            $('.navright li').mouseout(function(){
                $(this).find('.big-tu').hide();
            });
		 ...
		 $('.videos-btn').click(function(){
            ...
            var src = $('.introVideoDialog iframe').data("src");
            $('.introVideoDialog iframe').attr("src", src);
        });
        $('.btnClose').click(function(){

            $('.introVideoDialog').hide();
            $('.introVideoDialog iframe').attr("src", '');
            return false;
        });
