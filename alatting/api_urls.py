...
from alatting_website.view.statistics_viewset import (
    ...
    PosterFunViewSet, PosterFavoritesViewSet, PosterSubscribeViewSet
)
...
router.register(r'api/v1/posters/(?P<poster_id>\d+)/subscribe', PosterSubscribeViewSet, 'subscribe')
