  ...
  for (propName in properties){
    if (hasOwnProp.call(properties, propName)) {
      ...
      // http://www.w3.org/TR/wai-aria-primer/#ariahtml. Using setAttribute gets around this problem.
        ...
        if (propName.indexOf('aria-') !== -1 || propName == 'role' || propName == 'style') {
...
//    var parentIframe = parent.document.getElementById("iframepage");
//    if (parentIframe && document.domain == parent.document.domain) {
//        parentIframe.height = parent.window.screen.height;
//        $(parentIframe).parent("div").eq(0).addClass("fullScreenDivChange");
//    } //    parentIframe.width = parent.document.documentElement.scrollWidth;
...
//    var parentIframe = parent.document.getElementById("iframepage");
//    if (parentIframe && document.domain == parent.document.domain) {
//        parentIframe.height = oldHeight;
//        $(parentIframe).parent("div").eq(0).removeClass("fullScreenDivChange");
...
//    'aria-label': 'play video'
    //  });
    var left = (this.player_.width() - 113) / 2;
    var top = (this.player_.height() - 119) / 2;
    var stylePosition = "left:" + left + "px;top:" + top + "px";
    return vjs.Button.prototype.createEl.call(this, 'div', {
        className: 'vjs-big-play-button',
        innerHTML: '<span></span>',
        'aria-label': 'play video',
